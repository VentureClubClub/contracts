...
contract VentureClubUpgradeable_v4 is Initializable, ERC721Upgradeable, AccessControlUpgradeable {
    ...
    // deal id -> deal currency decimals
    mapping(bytes32 => uint8) dealCurrencyDecimals;
    ...
    event DealCreated(bytes32 id, address dealManager, address currency, uint8 currencyDecimals);
    ...
    function createDeal(bytes32 id,
        ...
        granted(abi.encode(msg.sender, id, dealManager, currency, currencyDecimals), grant, DEAL_ADMIN)
        external
    {
        ...
        dealCurrencyDecimals[id] = currencyDecimals;

        emit DealCreated(id, dealManager, currency, currencyDecimals);
    }
        ...
        external
    {
        ...
        emit Mint(to, tokenId, dealId, priceWei);
    }
